...
class PickAndPlacePanda(object):
  ...
  def pick(self, target_pose, target_name):
    ...
    pos = np.array(target_pose) + np.array([0, 0, 0.21])
    self.go_to(pos, q)
...
def MoveItPanda(target_pose, name):
  ...
  f = open("/home/ariele/catkin_ws/src/gazebo_eyegaze/src/app/gazebo_data.txt", "a")
